/* =========================================
   ...
   const projects = [
       ...
       },
       {
           ...
           links: {
               github: "https://github.com/griga178/",
               demo: null
           },
           hasDemo: false,
           fullDescription: {
             ru: `
                <span> полное описание не готово... </span>
              `,
             en: "<span> in rendering... </span>"
             },
       },
       {
           id: 4,
           ...
           tags: ["Python", "SQLAlchemy", "SQLite", "REST API"],
           links: {
               github: "https://github.com/griga178/",
               demo: false
           },
           hasDemo: false,
          fullDescription: {
            ru: `<span> полное описание не готово... </span>`,
            en: `<span> in rendering... </span>`,
          },
       },
       {
           ...
           tags: ["Python", "multiprocessing", "Openpyxl"],
           links: {
               github: null,
               demo: false
           },
       ...
       },
       {
           ...
           tags: ["Python", "SQLAlchemy", "binance"],
           links: {
               github: false,
               demo: false
           },
...
const filterCategories = [
    ...
    { key: "automation", label: { en: "Automation", ru: "Автоматизация" } },
    { key: "mart", label: { en: "Mart", ru: "Витрины данных" } },
    { key: "optimization", label: { en: "Optimization", ru: "Оптимизация" } }
];
